...
## ⚠️ প্রতিবার নতুন কোড আপডেট করার পর অবশ্যই করুন
পুরনো APK-এর উপর নতুন APK বসালে অনেক সময় Android পুরনো ভার্সনটাই cache করে রাখে
আর বাগ ফিক্স থাকা সত্ত্বেও পুরনো আচরণ দেখা যায়। তাই প্রতিবার:
1. ফোন থেকে আগের **MH Attendance** অ্যাপটা সম্পূর্ণ Uninstall করুন
2. GitHub রিপোতে **এই নতুন zip-এর ফাইলগুলো দিয়ে পুরনো ফাইলগুলো Replace/Overwrite** করে commit করুন (শুধু zip আপলোড করলেই হবে না — রিপোর পুরনো কোড আসলেই বদলাতে হবে)
3. Actions ট্যাব থেকে আবার **Run workflow** চাপুন এবং নতুন APK ডাউনলোড করুন
4. নতুন APK ইনস্টল করার পর **Settings → Apps → MH Attendance → App details** এ গিয়ে ভার্সন `1.0.1` দেখাচ্ছে কিনা যাচাই করুন — এটা দেখাচ্ছে মানে আসল আপডেটেড বিল্ডটাই ইনস্টল হয়েছে
